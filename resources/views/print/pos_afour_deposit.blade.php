...
<div id="printbox">
    ...
    <table  class="inv_info" width="100%">
        ...
        <tr>
            <th align="left" class="text-left">Deposit Number</th>
            <td>{{ $deposit->deposit_number }}</td>
            <th align="left" class="text-left">Deposit Date</th>
        ...
        <tr>
            ...
            <td>{{ date("h:i a",strtotime($deposit->sales_time)) }}</td>
        </tr>
        <tr>
            <th align="left" class="text-left">Customer Address</th>
            <td colspan="3">{{ $deposit->customer->address }}</td>
        </tr>
        <tr>
    ...
    <h2 style="margin-top:0" class="text-center">Deposit Receipt</h2>
    ...
    <table id="products">
        ...
        <tr>
            ...
            <th  align="right" class="text-right" style="font-size: 9pt;">{{ number_format($deposit->sub_total,2) }}</th>
        </tr>
        <tr>
            <td></td>
            <td></td>
            ...
            <th  align="right" class="text-right" style="font-size: 9pt;">{{ number_format($deposit->discount_amount,2) }}</th>
        </tr>
        <tr>
            <td></td>
            <td></td>
            ...
            <th  align="right" class="text-right" style="font-size: 9pt;"><b>{{ number_format(($deposit->sub_total -$deposit->discount_amount),2) }}</b></th>
        </tr>
        </tfoot>
    </table>
    ...
    <br/>
    <div align="center">
        <img src="data:image/png;base64,' . {{ DNS1D::getBarcodePNG((string)$deposit->id, 'C39',3,60) }} . '" alt="barcode"   />
    </div>
    <br/>
