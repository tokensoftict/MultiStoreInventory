<div class="col-sm-12">
    ...
    <div class="row">
        ...
        @if(userCanView('invoiceandsales.print_afive'))
            <div class="col-md-4">
                <a href="{{ route('invoiceandsales.print_afive',$invoice_id) }}" onclick="open_print_window(this); return false" class="btn btn-primary btn-lg btn-block">Print Invoice A5 <i class="fa fa-print"></i></a>
            </div>
        @endif
    </div>
    ...
    <div class="row mtop-20">
        <div class="col-md-12">
            <a href="{{ route('invoiceandsales.new') }}" class="btn btn-info btn-lg btn-block">New Sales / Invoice <i class="fa fa-plus"></i></a>
        </div>
    </div>
    <br/>
</div>
