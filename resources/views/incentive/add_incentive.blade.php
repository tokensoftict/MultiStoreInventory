                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        @if(isset($incentive->id))
                                <form action="{{ route('incentive.update') }}" method="post" enctype="multipart/form-data">
                            @else
                        ...
                        @endif
                            ...
                            <button type="submit" class="btn btn-primary text-center"><i class="fa fa-save"></i> Add Incentive</button>
